...
في قائمة الادمنيه اصبح ادمن جديد*""".format(f2,t2),parse_mode="markdown",disable_web_page_preview=True)
...
CH - @@T_4IJ : @T_4IJ*""",parse_mode="markdown",reply_to_message_id=message.message_id,reply_markup=p3)
	...
	if message.text == "صور" or message.text == "صوره" or message.text == "صورة" or message.text == "سمسم":
		photo_str =  random.randint(74,154)
		avtar_ball = "https://t.me/picture/" + str(photo_str)
...
اذا اكثر مـن  5$     كل     5$      =     1$
يعني : 15$  =     3$.  عـمـوله الـوسـيط

ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
تبادل : اي حساب  =     1k  عموله وسيط

ــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــــ
بالتوفيق ان شاء الله ونرجو الاحترام 💞
اذا ختلفت مع وسيط راسل  ⇐ @T_4IJ")
...
اذا ختلفت مع وسيط راسل  ⇐ @T_4IJ")
		...
		bot.reply_to(message,"اجي وياكم🙆") 
	elif message.text=="باي":
		bot.reply_to(message,"اجته رساله من الحب😻🙈")
...
- - - - - - - - - - - - - 
@T_4IJ*""",parse_mode="markdown",reply_markup=p3)
...
- - - - - - - - - - - - - -
@T_4IJ*""",reply_markup=p3,parse_mode="markdown")
  p3 = types.InlineKeyboardMarkup()
...
""".format(f2,t2),disable_web_page_preview=True,parse_mode="markdown",reply_markup=p3)
 ...
 الغاء كتم <<
 تقيد <<
 ايدي << ا او ايدي او id 
 كشف بالرد <<
 حسابي <<
 صورتي << يعطيك صورتك
 اسمي << يعطيك اسمك
 الوقت << يعطيك الوقت
 التاريخ << يعطيك التاريخ
 تاك باليوزر << 
 الرابط << يعطيك رابط المجموعه
 كت << يعطيك سؤال
 صوره << يعطي صور حلوه
 اذكار او ايه <<
